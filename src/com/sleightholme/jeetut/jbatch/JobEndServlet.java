 ...
 */
@WebServlet(name = "JobEnd", urlPatterns = {"/JobEnd"})
public class JobEndServlet extends ExtendedServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        header();
        out.print("Outputted file data is:</br>");
        try (BufferedReader fileIn = new BufferedReader(new FileReader("batchoutput.txt"))){
            ...
            out.println("Error finding output file");
            e.printStackTrace();
        }
