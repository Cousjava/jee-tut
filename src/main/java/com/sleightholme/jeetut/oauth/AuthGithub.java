...
public class AuthGithub extends ExtendedServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        header();
        //response.addHeader("client_id", CLIENT_ID);
        //response.addHeader("redirect_uri", "http://localhost/callback");
        //response.addHeader("state", "gagtrheejej");
        response.sendRedirect("https://github.com/login/oauth/authorize?client_id=" + CLIENT_ID + "&state=rhgiuhighrui");
